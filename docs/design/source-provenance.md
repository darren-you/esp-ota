...
本仓第一方源码采用 Apache-2.0，原仓作者为 DarrenYou。迁移基线是 `darren-you/esp-base` 的公开 `master` 提交 `10cb8514e8f7a3a55b8ec4622cce4f98a0f90eea`。下列四个来源文件已按该提交的原路径与 SHA-256 逐一核对；表中 SHA-256 指文件内容摘要，源码迁入后的修改见右栏。Base 的持久操作收据和业务自检没有迁入。
