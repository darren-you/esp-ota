...
typedef struct { void *context; int (*send)(void *,const unsigned char *,size_t); int (*recv)(void *,unsigned char *,size_t); int handshake_count; int record_bytes; } mbedtls_ssl_context;
